  ...
  return (
    <div >
      ...
      <div className="flex items-center justify-evenly w-full">
        <img src={require('../assets/images/fontbolt (4).png')} alt="left" className="w-10 lg:w-20 hidden lg:block " onClick={ () => flipBookRef.current.pageFlip().flipPrev('top')}/>
        <img src={require('../assets/images/fontbolt (3).png')} alt="right" className="w-10 lg:w-20 hidden lg:block " onClick={() => flipBookRef.current.pageFlip().flipNext('top')}/>
        <img src={require('../assets/images/fontbolt (9).png')} alt="left" className="w-10 lg:w-20 block lg:hidden " onClick={ () => flipBookRef.current.pageFlip().flipPrev('top')}/>
        <img src={require('../assets/images/fontbolt (8).png')} alt="right" className="w-10 lg:w-20 block lg:hidden " onClick={() => flipBookRef.current.pageFlip().flipNext('top')}/>
      </div>
        <HTMLFlipBook width={window.innerWidth > 600 ? window.innerWidth/3 : window.innerWidth} height={window.innerHeight-200} useMouseEvents={false} ref={flipBookRef} size="fixed" showCover={true} mobileScrollSupport={true} className="w-full bg-white-50 h-0 rounded-lg overflow-hidden">
